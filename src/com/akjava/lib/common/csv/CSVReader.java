...
/**
 * Copyright 2011-2013 aki miyazaki
 * modified for support String line for GWT not Reader but String
 */


/**
 * watch out CSVReader has some problem
 * can't read simple hello" line; you have to "hello""";
 * This means you have to quote all text...
 */
...
public class CSVReader {
     ...
     */
    public CSVReader(String reader) {
     ...
     */
    public CSVReader(String reader, char separator, char quotechar) {
     ...
     */
    public CSVReader(String reader, char separator, char quotechar, boolean strictQuotes) {
   ...
   /**
     ...
     */
    public CSVReader(String reader, char separator, char quotechar, int line) {
     ...
     *            the line number to skip for start reading
     */
    public CSVReader(String reader, char separator, char quotechar, char escape, int line) {
